...
path = 'data_faces' #path to save image
...
if choice == 'LOGIN': 
    st.markdown("<h2 style='text-align: center; color: white;'>ATTEDANCE</h2>", unsafe_allow_html=True) #title
    with col1: #column 1
        st.subheader("LOGIN")
...
#register menu
    ...
    if image_file is not None:
        ...
        with open(os.path.join("data_faces",image_file.name),"wb") as f: 
...
#read data menu
    ...
    with col2:
        ...
        st.header("Home page")
        st.subheader("Application attendence system") 
